...
const HeroUserCard = () => {
  return (
    <>
      <div className="h-[237px] w-[409px] border rounded-[45px] border-t-[#FFFFFF]/50 border-l-[#FFFFFF]/50 border-b-[#666666] border-r-[#666666] bg-linear-to-br from-[#FFFFFF]/5 to-[#666666]/5 bg-clip-border  backdrop-blur-[17px] absolute mt-[705px] ml-[43px]">
